...
public class PlayerDAO extends DAO<Player>{
    ...
    private static final String INSERT = "INSERT INTO demo.players" +
            "(name, country, age, points, tourn_played)" +
            "VALUES(?,?,?,?,?)";
    private static final String GET_ONE = "SELECT * FROM demo.players WHERE id = ?";
    private static final String GET_ALL = "SELECT * FROM demo.players";
    private static final String UPDATE = "UPDATE demo.players SET name = ?, country = ?, age = ?, points = ?, tourn_played = ? WHERE id = ?";
    private static final String DELETE = "DELETE FROM demo.players WHERE id = ?";
